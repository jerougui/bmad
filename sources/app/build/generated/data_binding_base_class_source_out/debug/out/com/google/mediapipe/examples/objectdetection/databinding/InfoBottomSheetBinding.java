...
public final class InfoBottomSheetBinding implements ViewBinding {
  ...
  @NonNull
  public final AppCompatSpinner spinnerInstrument;

  @NonNull
  public final AppCompatSpinner spinnerModel;

  @NonNull
  public final AppCompatSpinner spinnerSynthwaveStyle;
  ...
  private InfoBottomSheetBinding(@NonNull NestedScrollView rootView,
      ...
      @NonNull AppCompatSpinner spinnerDelegate, @NonNull AppCompatSpinner spinnerInstrument,
      @NonNull AppCompatSpinner spinnerModel, @NonNull AppCompatSpinner spinnerSynthwaveStyle,
    ...
    this.spinnerInstrument = spinnerInstrument;
    this.spinnerModel = spinnerModel;
    this.spinnerSynthwaveStyle = spinnerSynthwaveStyle;
  ...
  public static InfoBottomSheetBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.spinner_instrument;
      AppCompatSpinner spinnerInstrument = ViewBindings.findChildViewById(rootView, id);
      if (spinnerInstrument == null) {
        break missingId;
      }
      ...
      id = R.id.spinner_synthwave_style;
      AppCompatSpinner spinnerSynthwaveStyle = ViewBindings.findChildViewById(rootView, id);
      if (spinnerSynthwaveStyle == null) {
        break missingId;
      }
      ...
      return new InfoBottomSheetBinding((NestedScrollView) rootView, bottomSheetLayout,
          ...
          spinnerDelegate, spinnerInstrument, spinnerModel, spinnerSynthwaveStyle, thresholdMinus,
